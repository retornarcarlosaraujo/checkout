...
const CustomComboCard: React.FC<CustomComboCardProps> = ({ onSelect }) => {
  ...
  return (
    <div className="relative p-8 rounded-2xl border-2 border-dashed border-blue-300 bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-100 hover:shadow-2xl transition-all duration-300 hover:border-blue-400">
      {/* Custom Badge */}
      <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
        <div className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white text-xs font-bold px-4 py-2 rounded-full flex items-center space-x-1 shadow-lg">
      ...
      <div className="text-center pt-4">
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center justify-center space-x-4 mb-4">
            <button
              ...
              disabled={quantity <= 1}
              className="w-12 h-12 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 disabled:from-gray-300 disabled:to-gray-400 text-white rounded-full flex items-center justify-center font-bold text-xl shadow-lg hover:shadow-xl transition-all duration-200 disabled:cursor-not-allowed transform hover:scale-105"
            >
            ...
            <div className="relative">
              <input
                ...
                min="1"
                max="10000"
                className="w-24 h-12 text-center text-2xl font-black text-gray-800 border-2 border-blue-300 rounded-xl focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition-all duration-200"
              />
            </div>
        ...
        <button
          ...
          className="w-full py-3 px-6 bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-700 hover:to-indigo-800 text-white rounded-xl font-bold text-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300"
        >
          PERSONALIZAR COMBO
        </button>
      </div>
